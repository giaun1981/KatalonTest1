...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_searchSystemUseruserName'), 'Fiona')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/input_Status__search'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input_Username_searchSystemUseruserName'), 'Fiona.grace')
